	...
	<div class="footer ">
		<div class=" uk-container uk-container-center">
			<ul class= " menu-bottom uk-nav">
				...
				<li class="{{{ ((Route::currentRouteName()=='tieu-khu')?'uk-active':'') }}}" data-uk-dropdown><a href="{{Route('tieu-khu')}}">Tiểu Khu</a></li>
			...
			<div class=" info uk-grid">
				...
				<div class="item uk-width-large-1-3 uk-width-medium-1-3 uk-width-small-1-1">
					<div class="maps">
					<a href="tel:0967876969" title=""><img src="{{ asset('assets/images/bg_footer.jpg') }}"></a>
					</div>
				</div>
			</div>
		</div>
