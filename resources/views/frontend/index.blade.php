		...
		<!-- sản phẩm paragon -->
			...
			<div class="extentions uk-container uk-container-center">
				...
				<div class="desc ">
					...
					<ul class="uk-nav">
						<li><a href="{{ asset('samples/tien-ich/tien-ich-be-boi-trong-nha-du-an-hong-ha-eco-city.jpg') }}" title="Bể bơi trong nhà" data-uk-lightbox="{group:'group1'}">
							<img src="{{ asset('samples/tien-ich/tien-ich-be-boi-trong-nha-du-an-hong-ha-eco-city.jpg') }}" alt="Bể bơi trong nhà">
							<div class="light-text"><span>Bể bơi trong nhà</span></div>
						</a></li>
                        <li><a href="{{ asset('samples/tien-ich/tien-ich-rap-chieu-phim-hong-ha-eco-city-tu-hiep.jpg') }}" title="Rạp chiếu phim" data-lightbox-type="image" data-uk-lightbox="{group:'group1'}">
                            <img src="{{ asset('samples/tien-ich/tien-ich-rap-chieu-phim-hong-ha-eco-city-tu-hiep.jpg') }}" alt="Rạp chiếu phim">
                            <div class="light-text"><span>Rạp chiếu phim</span></div>
                        </a></li>
						<li><a href="{{ asset('samples/tien-ich/tien-ich-khu-vui-choi-eco-city-tu-hiep.jpg') }}" title="khu vui chơi trẻ em" data-lightbox-type="image" data-uk-lightbox="{group:'group1'}">
							<img src="{{ asset('samples/tien-ich/tien-ich-khu-vui-choi-eco-city-tu-hiep.jpg') }}" alt="khu vui chơi trẻ em">
							<div class="light-text"><span>khu vui chơi trẻ em</span></div>
						</a></li>
						<li><a href="{{ asset('samples/tien-ich/tien-ich-be-boi-ngoai-troi-chung-cu-eco-city.jpg') }}" title="Bể bơi ngoài trời" data-lightbox-type="image" data-uk-lightbox="{group:'group1'}">
							<img src="{{ asset('samples/tien-ich/tien-ich-be-boi-ngoai-troi-chung-cu-eco-city.jpg') }}" alt="Bể bơi ngoài trời">
