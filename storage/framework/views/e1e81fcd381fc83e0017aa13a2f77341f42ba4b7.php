          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo e(asset('backend/images/img.jpg')); ?>" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                        ...
                        <li><a href="<?php echo e(route('admin.index')); ?>"><i class="fa fa-home"></i>Home</a></li>
                        <?php if(Auth::user()->hasRole('admin')): ?>
                        <li><a href="<?php echo e(route('user-manage')); ?>"><i class="fa fa-home"></i>Quản lý thành viên</a></li>
                        <?php endif; ?>
                        <?php if(Auth::user()->hasAnyRole(['admin','author'])): ?>
                        <li><a href="<?php echo e(route('category-manager')); ?>"><i class="fa fa-home"></i>Quản lý danh mục</a></li>
                        <li><a href="<?php echo e(route('blog-manage')); ?>"><i class="fa fa-home"></i>Quản lý bài viết</a></li>
                       
                        <li><a href="<?php echo e(route('quy-can-hot')); ?>"><i class="fa fa-home"></i>Quản lý Quỹ căn hot</a></li>
                        <?php endif; ?>

                        <?php if(Auth::user()->hasRole('admin')): ?>
                        <li><a href="<?php echo e(route('customer')); ?>"><i class="fa fa-home"></i>Danh sách khách hàng</a></li>
                        <?php endif; ?>
                </ul>
              </div>            
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e(asset('backend/images/img.jpg')); ?>" alt="">
